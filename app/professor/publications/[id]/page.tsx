...
export default function ProfessorPublicationDetail(
  ...
  if (err) return (
    <div className="min-h-screen p-6">
      <div className="mb-4"><Link href="/professor/dashboard" className="text-blue-600">← กลับ</Link></div>
  ...
  return (
    <div className="min-h-screen p-6">
      <div className="mb-4 flex items-center justify-between">
        <Link href="/professor/dashboard" className="text-blue-600">← กลับ</Link>
        <Link href={`/professor/publications/${data.pub_id}/edit`} className="px-3 py-2 rounded-lg bg-gray-800 text-white text-sm">แก้ไข</Link>
      </div>
